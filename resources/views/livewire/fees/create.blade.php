        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('fees.store') }}" method="POST">
                        @csrf
                        <div class="form-group mb-4">
                            <label for="semester">Semester</label>
                            <select name="semester" id="semester" class="js-example-basic-single form-control" style="width:100%">
